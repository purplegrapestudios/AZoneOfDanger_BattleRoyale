        ...
        SubShader{
            ...
            Pass {
                ...
                fixed4 frag(v2f i) : SV_Target {
                    ...
                    float3 waterColor = lerp(_ShallowColor, _DeepColor, i.worldPos.y / _WaterLevel);
                    ...
                    //i.worldPos.y += wavePattern;

                    // Output the final color of the fragment
                    return fixed4(waterColor, 0.8);
                }
                ENDCG
            }
        }
